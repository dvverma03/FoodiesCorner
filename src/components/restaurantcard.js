...
const RestaurantCard = ({ cloudinaryImageId, name, locality, costForTwo, cuisines, avgRating, availability }) => {
  ...
  return (
    <div className="m-2 w-80 p-4 hover:border-2 box-border rounded-md" style={cardStyle}>
